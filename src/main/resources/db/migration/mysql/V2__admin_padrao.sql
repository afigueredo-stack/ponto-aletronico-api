...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Joystick Loja');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@afigueredo.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
